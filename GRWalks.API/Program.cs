...
var logger = new LoggerConfiguration()
    .WriteTo.Console()
    .WriteTo.File("Logs/GRWalks_Log.txt", rollingInterval: RollingInterval.Day)
...
{
    options.SwaggerDoc("v1", new OpenApiInfo { Title = "GR  Walks API", Version =  "v1" });
...
builder.Services.AddIdentityCore<IdentityUser>()
    ...
    .AddTokenProvider<DataProtectorTokenProvider<IdentityUser>>("GRWalks")
    .AddEntityFrameworkStores<GRWalksAuthDbContext>()
